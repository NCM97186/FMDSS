define([
    ...
    return declare([GraphicsLayer], {
        ...
        _getGeoJson: function (ShapeJson) {
            // Check data
            //debugger;
            if (ShapeJson.type !== "FeatureCollection" || !ShapeJson.features) {
            ...
            var arcgisJson = this._terraformerConverter(ShapeJson);
