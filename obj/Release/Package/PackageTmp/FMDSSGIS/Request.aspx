                ...
                <form id="postData" name="postData" method="post" runat="server">
                    <div class="row">
                        <div class="col-lg-4 text-center">
                            <a class='btn btn-success' href="javascript:void();" target="_parent" id="mine_Req" onclick="submitPost(this,'permitlocation/GetRequest.aspx');" rel = 'noopener noreferrer'>Mine Request</a>
                            <a class='btn btn-danger' href="javascript:void();" target="_blank" id="cable_Req" onclick="submitPost(this,'permitlocation/GetRequest.aspx');" rel = 'noopener noreferrer'>Cable Request</a>
                            <a class='btn btn-primary' href="javascript:void();" target="_blank" id="gis_Req" onclick="submitPost(this,'gisview/ViewonGis.aspx');" rel = 'noopener noreferrer'>View on GIS</a>
                            <a class='btn btn-primary' href="javascript:void();" target="_blank" id="mine" onclick="submitPost(this,'permitlocation/GetRequest1.aspx');" rel = 'noopener noreferrer'>OLD Mine Req</a>
                            <a class='btn btn-danger' href="javascript:void();" target="_blank" id="cble" onclick="submitPost(this,'permitlocation/GetRequest1.aspx');" rel = 'noopener noreferrer'>OLD Line Req</a>
                            <a class='btn btn-danger' href="javascript:void();" target="_blank" id="villagedraw" onclick="submitPost(this,'getvillagedata/GetVillageIds.aspx');" rel = 'noopener noreferrer'>Village Draw</a>
                        </div>
                        <div class="col-lg-4 text-center">
                            <%--,098845,098855,099331,099812--%>
                            <a class='btn btn-warning' href="javascript:void();" target="_blank" id="draw_Req" onclick="submitPost(this,'activity/drawRequest.aspx');" rel = 'noopener noreferrer'>Draw Request</a> &nbsp;
                             <a class='btn btn-info' href="javascript:void();" target="_blank" id="thematic_Req" onclick="submitPost(this,'kpi/theme.aspx');" rel = 'noopener noreferrer'>Thematic Page</a>
                        </div>
                        <div class="col-lg-4 text-center">
                            <a class='btn btn-info' href="javascript:void();" target="_blank" id="depot_Req" onclick="submitPost(this,'DNM/dnm.aspx');" rel = 'noopener noreferrer'>Depot Request</a>
                            <a class='btn btn-info' href="javascript:void();" target="_blank" id="nursery_Req" onclick="submitPost(this,'DNM/dnm.aspx');" rel = 'noopener noreferrer'>Nursery Request</a>
                            <a class='btn btn-info' href="javascript:void();" target="_blank" id="offense_Req" onclick="submitPost(this,'markoffense/offense.aspx');" rel = 'noopener noreferrer'>Offense Request</a>
                        </div>
                    </div>
