<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportCitizenServiceDivisionWise.aspx.cs" Inherits="FMDSS.ReportCitizenServiceDivisionWise" %>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
          <table style=" width:80% ">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DDL_PermissionStatus" runat="server" >
