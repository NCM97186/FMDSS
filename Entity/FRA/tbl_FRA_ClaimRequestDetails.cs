...
{
    public class tbl_FRA_ClaimRequestDetails : CommonEntity
    {
        [Key]
        ...
        public string AppealRequestID { get; set; }
        [Required]
        ...
        //public virtual List<tbl_FRA_WorkFlowDetails> WorkFlowDetailsList { get; set; }
    }
}
