...
namespace FMDSS.APIHelpers
{
    public sealed class SqlHelper
    {
        ...
        /// using the provided parameters.
        /// </summary>
        /// <param name="sType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="query">The stored procedure name or T-SQL command</param>
        /// <param name="paramList">An array of SqlParamters used to execute the command</param>
        /// <returns></returns>
        public static int ExecuteNonQuery(CommandType sType, string query, object[] paramList)
        {
        ...
        /// <summary>
        /// Execute a SqlCommand (that returns a result and takes no parameters) against the database specified in 
        /// the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param> 
        /// <returns>A datatable containing the result generated by the command</returns>
        public static DataTable ExecuteStoredProcedure(string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteDataTable(CommandType.StoredProcedure, commandText, commandParameters);
        }
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        public static SqlParameter[] GetCachedParameterSet(string connectionString, string commandText)
        {
            ...
            SqlParameter[] cachedParameters = _paramCache[hashKey] as SqlParameter[];
        ...
        private static SqlParameter[] GetSpParameterSetInternal(SqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            ...
            cachedParameters = _paramCache[hashKey] as SqlParameter[];
            if (cachedParameters == null)
            {
