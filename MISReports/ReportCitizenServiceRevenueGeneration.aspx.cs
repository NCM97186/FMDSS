...
namespace FMDSS
{
    public partial class ReportCitizenServiceRevenueGeneration : System.Web.UI.Page
    {
        ...
        protected void Button_GetReport_Click(object sender, EventArgs e)
        {
            ...
            rptViewer.ServerReport.ReportPath = "/FMDSS_MISREPORTS/ReportCitizenServiceRevenueGeneration"; //Passing the Report Path                
