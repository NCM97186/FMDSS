...
namespace FMDSS.Models.CitizenService.ProductionServices
{
    ...
    public class TransitPermit : DAL
    {
        ...
        public string CREATE_RequestPermit(TransitPermit obj)
        {
            try
            {
                #region Convert Model Into Datatable
                ...
                DALConn();
                DataTable dtTag = new DataTable();
                SqlCommand cmd = new SqlCommand("sp_Citizen_TransitPermitrequest", Conn);
                cmd.Parameters.AddWithValue("@PERMIT_NO", obj.PERMIT_NO);
                cmd.Parameters.AddWithValue("@DIVISION_OFFICE", obj.DIVISION_OFFICE);
                cmd.Parameters.AddWithValue("@RANGE_OFFICE", obj.RANGE_OFFICE);
                cmd.Parameters.AddWithValue("@TO_STATE", obj.TO_STATE);
    ...
    public class CitizenTransmitpermitSummary:DAL
    {
        public CitizenTransmitpermitSummary()
        {
            ProductList = new List<ProductDetails>();
        }
        public List<ProductDetails> ProductList { get; set; }

        public string CitizenTransmitpermitPending { get; set; }

        public string CitizenTransmitpermitApproved { get; set; }

        public string CitizenTransmitpermitReject { get; set; }

        public string CitizenTransmitpermitTotal { get; set; }
        ...
        public string APPLICANT_DISTRICTNAME { get; set; }

        public string APPLICANT_TEHSIL { get; set; }

        public string APPLICANT_TEHSILNAME { get; set; }

        public string APPLICANT_VILLAGE { get; set; }

        public string APPLICANT_VILLAGENAME { get; set; }
        ...
        public int TP_FEES { get; set; }
        public int FROM_STATE { get; set; }
        public string FROM_STATENAME { get; set; }
        public int TO_STATE { get; set; }
        public string TO_STATENAME { get; set; }
        public int FROM_DISTRICT { get; set; }

        public string FROM_DISTRICTNAME { get; set; }

        public int TO_DISTRICT { get; set; }
        public string TO_DISTRICTNAME { get; set; }
        ...
        public DataSet CitizenTransmitpermitSummaryCount(long userid)
        {
        ...
        public DataTable GetdashboardDetails(long userid)
        {
            DataTable dtdropdown = new DataTable();
            try
            {
                DALConn();
                SqlCommand cmd = new SqlCommand("sp_Cititentransmitpermitlist", Conn);
                cmd.Parameters.AddWithValue("@userid", userid);
                cmd.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dtdropdown);
        ...
        public DataTable dashboardDetails(long userid,int ListId)
        {
            DataTable dtdropdown = new DataTable();
            try
            {
                DALConn();
                SqlCommand cmd = new SqlCommand("sp_DFOtransmitpermitlist", Conn);
                cmd.Parameters.AddWithValue("@userid", userid);
        ...
        public DataSet CitizenTransmitpermitApprove(string PermitNo)
        {
            DataSet dt = new DataSet();
            try
            {
                DALConn();
                SqlCommand cmd = new SqlCommand("sp_Citizen_transmitpermitapprove", Conn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string CitizenTransmitpermitPermission(CitizenTransmitpermitSummary objmodel)
        {
            try
            {
                DALConn();
                SqlCommand cmd = new SqlCommand("sp_citizentransmitpermitapprver", Conn);
                cmd.Parameters.AddWithValue("@PermitNo", objmodel.PERMIT_NO);
                cmd.Parameters.AddWithValue("@Action", objmodel.ACTION);
                cmd.Parameters.AddWithValue("@ActiontakenBy", objmodel.UserId);
        ...
        public DataSet CitizenTransmitpermitPrint(string PermitNo)
        {
            DataSet dt = new DataSet();
            try
            {
                DALConn();
                SqlCommand cmd = new SqlCommand("sp_Citizen_transmitpermitPrint", Conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@PermitNo", PermitNo);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
