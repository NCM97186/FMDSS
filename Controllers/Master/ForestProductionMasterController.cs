...
{
    public class ForestProductionMasterController : BaseController
    {
        ...
        public ActionResult SubmitDepotForm(FormCollection fm, string Command)
        {
            ...
            try
            {
                ...
                depot.DivisionCode = Convert.ToString(fm["DivisionCode"]);
                depot.CircleCode = Convert.ToString(fm["CircleCode"]);
                depot.DepotType = Convert.ToString(fm["DepotType"]);
                depot.RangeCode = Convert.ToString(fm["RangeCode"]);
                depot.DepotName = Convert.ToString(fm["DepotName"]);
                depot.DepotIncharge = Convert.ToString(fm["DepotIncharge"]);
                depot.DesignationID = Convert.ToString(fm["Designation"]);
                depot.Latitude = Convert.ToString(fm["Latitude"]);
                depot.Longitude = Convert.ToString(fm["Longitude"]);
            ...
            return RedirectToAction("ManageDepot", "ForestProductionMaster");
        }
                ...
                if (!String.IsNullOrEmpty(DepotID))
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            obj_dm.Latitude = dr["Latitude"].ToString();
                            obj_dm.Longitude = dr["Longitude"].ToString();
                        }
                    }
                }
            }
