...
namespace FMDSS.Models
{
    public class Common : DAL
    {
        ...
        {
            IList<SelectListItem> _result = new List<SelectListItem>();
            _result.Add(new SelectListItem { Value = "1", Text = "Quintal" });
            _result.Add(new SelectListItem { Value = "2", Text = "No.Of Packing" });
            _result.Add(new SelectListItem { Value = "3", Text = "Standard Bar" });
        ...
        public static IList<SelectListItem> GetSawmillType()
        {
            ...
            _result.Add(new SelectListItem { Value = "2", Text = "Wood Handicraft Saw mills" });
            return _result;
        }
        ...
        public static string GenerateBody(decimal Amount, string UserName, string TransID, string PermissionDesc)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    sb.Append("To view status of your application please <a href='"+ ConfigurationManager.AppSettings["websiteUrl"].ToString() +"'> click here</a>.");
                    //To view status of your application please click here.
                    sb.Append("<br/><br/>");
                    sb.Append("Thanks");
                    sb.Append("<br/><br/>");
        ...
        public static string GenerateReviwerBody(string UserName, string TransID, string PermissionDesc)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    sb.Append("Dear " + UserName + ",");
                    sb.Append("<br />");
                    sb.Append("<p>A Citizen raised a permission request for the " + PermissionDesc + " by the Request ID <b>#" + TransID + ".</b></p>");
                    sb.Append("<br/>");
        ...
        public static string GenerateSMSBody(string UserName, string TransID, string PermissionDesc)
        {
           ...
           // sb.Append("<div width='100%'>");
            sb.Append("Dear " + UserName + ",");
            //sb.Append("<br />");
            //sb.Append("<p>Thanks for showing interest in " + PermissionDesc + " and your Transaction ID <b>#" + TransID + ".</b></p>");
            //sb.Append("<br/>");
            sb.Append("Thanks for showing interest in " + PermissionDesc + " and your Transaction ID #" + TransID + ".");
            sb.Append("We will contact with you shortly.");
