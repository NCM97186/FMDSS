...
namespace FMDSS.Models
{
    ...
    public class KioskUserDetail : DAL
    {
        ...
        public DataTable SaveKisokUserDetails(KioskUserDetail _objModel)
        {
        ...
        public DataTable UpdateEmitraKioskTransactionStatus(eMitraObjForPayment _objModel, string ACTION,string status)
        {
            DataTable dtKiosk = new DataTable();
            try
            {
        ...
        public void SaveKioskEmitraResponse(eMitraObjForPayment _objModel)
        {
            DataTable dtKiosk = new DataTable();
            try
            {
     ...
     [Serializable]
    public class eMitraObjForPayment:BaseModelSerializable
    {
    ...
    [Serializable]
    public class VerifyTransactionForChecksum:BaseModelSerializable
    {
        public string MERCHANTCODE { get; set; }
       // public string SERVICEID { get; set; }
        public string REQUESTID { get; set; }
     ...
     [Serializable]
    public class eMitraObjectForPaymentChecksum : BaseModelSerializable
    {
        public string SSOID { get; set; }
       public string REQUESTID { get; set; }
        public string REQTIMESTAMP { get; set; }
        public string SSOTOKEN { get; set; }
        public string GetCheckSum(eMitraObjForPayment req)
        {
        ...
        public string GetCheckSumForVerifyTrans(VerifyTransaction _objVerifyTransaction)
        {
            VerifyTransactionForChecksum obj = new VerifyTransactionForChecksum();
    ...
    [Serializable]
    public class KioskPaymentDetails : DAL
    {
        ...
        public DataTable FetchKisokValue1(KioskPaymentDetails _objModel)
        {
            DataTable dtKiosk = new DataTable();
            try
            {
        ...
        public DataTable FetchKisokValue(KioskPaymentDetails _objModel)
        {
            DataTable dtKiosk = new DataTable();
            try
            {
    ...
    [Serializable]
    public class PaymentByDepartmentalKioskUserDetails : DAL
    {
        public string RequestedId { get; set; }
    ...
    [Serializable]
    public class VerifyTransaction:BaseModelSerializable
    {
        public string MERCHANTCODE { get; set; }
        public string SERVICEID { get; set; }
        public string REQUESTID { get; set; }
