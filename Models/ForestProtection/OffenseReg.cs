...
namespace FMDSS.Models.ForestProtection
{
    ...
    public class OffenseReg : DAL
    {
        ...
        public DataTable Get_DecisionTaken()
        {
            try
            {
                DALConn();
                DataTable dt = new DataTable();
                SqlParameter[] parameters = { new SqlParameter("@DropDownType", "DecisionTaken"),
                                              new SqlParameter("@Id", "")
                                            };
                Fill(dt, "Sp_FPM_Common_SelectDropDown", parameters);
                return dt;
        ...
        public DataTable Get_ReasonOfCaseFailed()
        {
            try
            {
                DALConn();
                DataTable dt = new DataTable();
                SqlParameter[] parameters = { new SqlParameter("@DropDownType", "ReasonOfCaseFailed"),
                                              new SqlParameter("@Id", "")
                                            };
                Fill(dt, "Sp_FPM_Common_SelectDropDown", parameters);
                return dt;
