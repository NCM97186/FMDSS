...
namespace FMDSS.Models.ForestProtection
{
    ...
    public class OffenseRegistrationfinal : DAL
    {
        ...
        // [Required(ErrorMessage="select visit date")]
        public string VisitDate { get; set; }
        //[Required(ErrorMessage="Enter visit palce"),MaxLength(100)]
        public string VisitPlace { get; set; }
        //[Required(ErrorMessage="select visit time")]  
        public string VisitTime { get; set; }
        // [Required(ErrorMessage = "Enter crime description")]
        ...
        /// <summary>
        /// Save the records of Crime scene
        /// </summary>
        /// <param name="dtCrime"></param>
        /// <returns></returns>
        public Int64 InsertCrimeSceneDetails(DataTable dtCrime)
        {
            Int64 chk = 0;
            try
            {
                ...
                {
                new SqlParameter("@ID", CrimeSceneID ),     
                ...
                new SqlParameter("@CrimeDetails",dtCrime),        
                };
                chk = Convert.ToInt64(ExecuteScalar("SP_FPM_InsertCrimeSceneDetails", parameters));              
            }
            catch (Exception ex)
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "InsertCrimeSceneDetails" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        /// <returns></returns>
        public Int64 InsertSeizedItemTeam(DataTable dtVechile, DataTable dtProduce, DataTable dtEquipment, DataTable dtAnimal, DataTable dtAnimalDescription)
        {
            Int64 chk = 0;
            try
            {
                ...
                SqlParameter[] parameters =
                        {
                        new SqlParameter("@ID", SeizedItemId ),                              
                        new SqlParameter("@OffenseCode",HttpContext.Current.Session["FPMOffenseID"]),           
        ...
        public Int64 InsertIssueJamanat()
        {
            ...
            try
            {
                ...
                SqlParameter[] parameters =
                        ...
                        new SqlParameter("@GuarantorPincode", GuarantorPincode ), 
        ...
        public string TabShowInfo(string option)
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "TabShowInfo" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        public DataSet GetForestDetails()
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "GetForestDetails" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        public DataTable GetForestOfficers(string OffenseCode)
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "GetForestOfficers" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        public DataTable GetForestOfficersDesignation(string ssoid)
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "GetForestOfficersDesignation" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        public DataTable GetDropdown(string option)
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "GetDropdown" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        public DataTable GetOffenderName()
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "GetOffenderName" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
        ...
        public DataTable GetCourtCaseDetailByOffenceCode()
        {
            ...
            {
                new Common().ErrorLog(ex.InnerException + "_" + ex.StackTrace, "GetCourtCaseDetail" + "_" + "OffenseRegistrationfinal", 4, DateTime.Now, Convert.ToInt64(HttpContext.Current.Session["UserId"]));
            }
            finally
            {
                Conn.Close();
