...
namespace FMDSS.Models.CitizenService.PermissionService.StakeholderService
{
    public class StakeholderServices:DAL
    {
        ...
        public string TypeVfmc { get; set; }
        ...
        [Required(ErrorMessage = "Enter lattitude")]
        public decimal Lattitude { get; set; }
        [Required(ErrorMessage = "Enter longitude")]

        public decimal Longitude { get; set; }
        [Required(ErrorMessage = "Enter village area(In hectare)")]
        public decimal Village_Area { get; set; }
        ...
        public Int64 InsertJFMC(StakeholderServices stk)
        {
            try
            {
                ...
                SqlParameter[] parameters =
                        ...
                        new SqlParameter("@Range_Code", stk.RANGE_CODE),      
                        new SqlParameter("@Vill_Code", stk.hdnVillageCode),    
                        ...
                        new SqlParameter("@Village_Area", stk.Village_Area),
                        ...
                        new SqlParameter("@TypeVfmc", stk.TypeVfmc),
        ...
        public DataTable GetJFMCMember(string JFMCRegistration)
        {
            ...
            {
                DALConn();
                SqlCommand cmd = new SqlCommand("select SSOId,FullName,AadharId,BhamashahId,DateOfBirth,Gender,EmailId,MobileNo,Address1,Designation,Roles from tbl_JFMCMemberdetails where JFMCMemberRegistrationId=" + JFMCRegistration, Conn);
